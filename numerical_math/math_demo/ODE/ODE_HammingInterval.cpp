//ODE_HammingInterval.cpp	全区间积分哈明法
#include <fstream>
#include <dirent.h>
#include <string> 
#include <iostream>
...
int main(void)
{	
	double y[3] = {1.0, 1.0, 1.0}, t(0.0), h(0.05), eps(FLOATERROR);
	...
	ODE_HammingInterval(t, h, vy, eps, 11, vz);
...
//计算微分方程组中各方程右端函数值
template <class _Ty>
void FunctionValueHI(_Ty t, valarray<_Ty>& y, valarray<_Ty>& d)
{
