...
#include "Matrix.hpp"//模板类矩阵头文件
#include "Comm.hpp"		//公共头文件
...
* @param x 
* 		 y
* 		 a 类型引用， 长度为M， 返回 m-1  次， 拟合多先吃的M个系数
* 		 dt 引用， 长度为3 ， dt(0) 误差平方和， DT(1) 返回拟合多项式 和数据误差绝对值之和, dt(2) 返回误差绝对值的最大值	
* @return 	
* *************************************************************************/
template <class _Ty>
